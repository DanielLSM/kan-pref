...
if __name__ == "__main__":  # noqa: C901
    ...
    parser.add_argument("--loss_type", type=str, default="", help="override callback")
    parser.add_argument("--lambda_init", type=float, default=1, help="Lambda init")
    parser.add_argument("--lambda_max", type=float, default=5, help="Lambda max - How much we weight cost")
    ...
    if args.track:
        ...
        wandb.login(key="KEY_HERE")
        run_name = f"{args.env}__{date_time}__{args.seed}__{args.loss_type}"
        run = wandb.init(
            name=run_name,
