...
#from pref.moderate import HumanCritic
...
def get_preference_callbacks(hyperparams, hc, env_name, override_callback=None):
    """
    ...
    if "callback" in pref_dict.keys():
        ...
        if override_callback != "":
            callback_key = list(callback_name[0].keys())[0]
            hyperparams_callback = callback_names[0][callback_key]
            del callback_names[0][callback_key]

            callback_names[0][override_callback] = hyperparams_callback
