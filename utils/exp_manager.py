...
class ExperimentManager:
    ...
    def setup_experiment(self) -> Optional[Tuple[BaseAlgorithm, Dict[str, Any]]]:
        ...
        constrained = True if self.args.loss_type == "final" else False
    ...
    def save_trained_model(self, model: BaseAlgorithm) -> None:
        ...
        self.hc.save_reward_model(f"{self.save_path}/rewardmodel")
        self.hc.save_cost_model(f"{self.save_path}/costmodel")
        self.hc.save_buffers(f"{self.save_path}/")
    ...
    def _preprocess_hyperparams(
        ...
        if "pref_learning" in hyperparams.keys():
            if hyperparams["pref_learning"]["active"]:
                ...
                if self.args.loss_type:
                    print("Regularize")
                    hyperparams["pref_learning"]["human_critic"]["loss_type"] = self.args.loss_type
                else:
                    print("No regularize")
